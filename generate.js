...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (resendKey) {
      ...
      const blue = '#00aaff';
      const footer = `<p style="color:#999;font-size:12px;margin-top:32px;border-top:1px solid #eee;padding-top:16px;">Plan My Program · Powered by <strong>Clear Path Leadership</strong> · clearpathokc.com</p>`;
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'Plan My Program <noreply@clearpathokc.com>',
        ...
        await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            ...
            html: `<div style="${baseStyle}">
              <p style="color:#555;margin-bottom:24px;">Here's the program plan you built at <a href="https://clearpathokc.com/planmyprogram" style="color:${blue};">clearpathokc.com/planmyprogram</a>. Keep it somewhere safe — this is your starting point.</p>
              ${planHtml}
